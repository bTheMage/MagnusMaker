...
void LavaDevice::createSurface() { window.createWindowSurface(instance, &surface_); }
...
void LavaDevice::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT &createInfo) {
  createInfo = {};
