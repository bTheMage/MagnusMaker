...
VkResult LavaSwapChain::submitCommandBuffers(
...
VkSurfaceFormatKHR LavaSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR LavaSwapChain::chooseSwapPresentMode(
