...
namespace lava {
  ...
  LavaPipeline::~LavaPipeline() {
    vkDestroyShaderModule(lavaDevice.device(), fragShaderModule, nullptr);
    vkDestroyShaderModule(lavaDevice.device(), vertShaderModule, nullptr);
    vkDestroyPipeline(lavaDevice.device(), graphicsPipeline, nullptr);
  }
  ...
  void LavaPipeline::createGraphicsPipeline(
      const std::string& vertFilepath,
      const std::string& fragFilepath,
      const PipelineConfigInfo& configInfo
  ) {
  ...
  void LavaPipeline::createShaderModule(const std::vector<char>& code, VkShaderModule* shaderModule) {
    ...
    if (vkCreateShaderModule(lavaDevice.device(), &createInfo, nullptr, shaderModule) != VK_SUCCESS) {
